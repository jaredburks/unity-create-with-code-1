...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cube_Awake_mD02462AC1F0338F62FBA74B309A43513D7A0D6C5 (Cube_tEB0CADF2ED5CCD174FE21940A8708AFFBC74872B* __this, const RuntimeMethod* method) 
{
	{
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_0;
		memset((&L_0), 0, sizeof(L_0));
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_0), (-0.00999999978f), (-0.00999999978f), (-0.00999999978f), NULL);
		__this->___scaleChange = L_0;
		return;
	}
}
...
{
	{
		...
		Transform_Rotate_m7EA47AD57F43D478CCB0523D179950EE49CDA3E2(L_0, (0.0f), ((float)il2cpp_codegen_multiply(((float)il2cpp_codegen_multiply((10.0f), L_1)), L_2)), (0.0f), NULL);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_3;
		L_3 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		float L_4;
		L_4 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		Transform_Translate_mB42A27EE20E123E0B47336F795B62B017489E3F7(L_3, ((float)il2cpp_codegen_multiply((1.0f), L_4)), (0.0f), (0.0f), NULL);
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_8 = __this->___scaleChange;
		...
		MeshRenderer_t4B7747212F0B88244BB7790C61AE124BFC15BAAE* L_10 = __this->___Renderer;
		...
		float L_12 = __this->___colorChangeRate;
		float L_13 = __this->___colorChangeRate;
		float L_14;
		L_14 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		__this->___colorChangeRate = ((float)il2cpp_codegen_add(L_12, ((float)il2cpp_codegen_multiply(L_13, L_14))));
		Material_t18053F08F347D0DCA5E1140EC7EC4533DD8A14E3* L_15 = __this->___material;
		float L_16 = __this->___colorChangeRate;
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_17;
		memset((&L_17), 0, sizeof(L_17));
		Color__ctor_m3786F0D6E510D9CFA544523A955870BD2A514C8C_inline((&L_17), L_16, (5.0f), (0.899999976f), (0.100000001f), NULL);
		Material_set_color_m5C32DEBB215FF9EE35E7B575297D8C2F29CC2A2D(L_15, L_17, NULL);
		return;
	}
}
...
{
	{
		__this->___colorChangeRate = (0.00999999978f);
